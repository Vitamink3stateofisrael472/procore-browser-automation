/**
 * basic-login.js — Basic login example for Procore
...
async function main() {
  ...
  try {
    log('Starting Procore automation (Open Source mode)');
    ...
    const result = await login_procore(page, {
    ...
    // const data = await create_rfi(page, {});
    // log('Data:', data);
